...
struct WshEventData
{
    ...
    WshEventData(int conId_, bool fillWatchlist_, bool fillPortfolio_, bool fillCompetitors_, std::string startDate_,
        std::string endDate_, int totalLimit_)
    {
        this->conId = conId_;
        this->filter = "";
    ...
    WshEventData(std::string filter_, bool fillWatchlist_, bool fillPortfolio_, bool fillCompetitors_,
        std::string startDate_, std::string endDate_, int totalLimit_)
    {
        this->conId = INT_MAX;
        this->filter = filter_;
        this->fillWatchlist = fillWatchlist_;
